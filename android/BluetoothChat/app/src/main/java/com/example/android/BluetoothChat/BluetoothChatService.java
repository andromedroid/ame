...
public class BluetoothChatService {
	...
	public static final int	STATE_NONE			= 0;	// stop()		we're doing nothing
	public static final int	STATE_LISTEN		= 1;	// start()		now listening for incoming connections
	public static final int	STATE_CONNECTING	= 2;	// connect()	now initiating an outgoing connection
	public static final int	STATE_CONNECTED		= 3;	// connected()	now connected to a remote device
	...
	/**
	 *	onResume(), sendMessage() -> Return the current connection state.
	 */
	...
	/**
	 *	onResume() -> [LISTEN] スレッド "AcceptThread" を起床する。
	...
	/**
	 *	connectDevice() -> [CONNECTING] スレッド "ConnectThread" を起床する。
	...
	/**
	 *	this.run() -> [CONNECTED] スレッド "ConnectedThread" を起床する。
	...
	/**
	 *	onDestroy() -> [NONE] Stop all threads
	 */
	...
	/**
	 *	ConnectThread.run() -> Indicate that the connection attempt failed and notify the UI Activity.
	 */
	...
	/**
	 *	ConnectedThread().run -> Indicate that the connection was lost and notify the UI Activity.
	 */
